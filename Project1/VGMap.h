...
public:
	...
	BuildingSlot(int Points_, int BuildingSlot_id_,Building* Building_); //parameterized constructor with adjacent BuildingSlots
	BuildingSlot(std::vector<BuildingSlot *> adjacentBuildings_, int Points_, int BuildingSlot_id_,Building* Building_); //parameterized constructor with adjacent BuildingSlots
...
public:
	...
	BuildingSlot* getBuildingSlotByID(int ID);
	//void resetVGMap();

	BuildingSlot* searchByID(int Id);
